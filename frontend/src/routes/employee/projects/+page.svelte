<script>
	...
	var MyManagerID = currentUser.manager
	...
	async function GetProjects() {
		...
		//filter project with id of customer
		projects = projects.filter(project => project?.leader[0]._id?.includes(MyManagerID));
	}
...
<div class="-ml-16 sm:ml-5 mt-0 z-0 w-auto h-fit bg-base-100 rounded-md p-5 rounded-tl-none">
	<h1 class="prose mb-3 font-bold text-2xl sm:text-3xl text-left">My Project</h1>
