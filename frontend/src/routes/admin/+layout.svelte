<!-- <script>
	import Header from "../header/HeaderAdmin.svelte";
	import "./styles.css";
	import "../../app.css";
...
<div class="app dark:bg-gray-900">
	<Header accountName={currentUser.account_name} />
...
<script>
	...
	import Sidebar from '$lib/components/Utilities/Sidebar/AdminSidebar.svelte';
...
<div class="page-container flex h-auto">
	<div class="z-10 w-16 sm:w-auto h-fit">
		<button
